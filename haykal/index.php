...
<body>
    ...
    <nav class="navbar navbar-expand-lg navbar-dark bg-dark text-uppercase">
        <div class="container">
            <a class="navbar-brand" href="index.php">UNIVERSITAS LABUHANBATU</a>
    ...
    <div class="container">
        <div class="row my-2">
            <div class="col-md">
                <h3 class="text-center fw-bold text-uppercase">Data Mahasiswa Universitas Labuhanbatu</h3>
                <hr>
            </div>
        </div>
        <div class="row my-2">
    ...
    $('#data').DataTable({
        ...
        "info": false // Menonaktifkan informasi tampilan\
