<?php
session_start();
// Jika sudah login maka ke halaman index.php
...
if (isset($_POST['login'])) {
    ...
    $password = $_POST['password']; // password menggunakan md5
...
<body>
    ...
    <nav class="navbar navbar-expand-lg navbar-dark bg-dark">
        <div class="container">
            <a class="navbar-brand" href="index.php">LOGIN ULB</a>
    ...
    <div class="container">
        <div class="row my-5">
            <div class="col-md-6 text-center login" style="background-image: url('img/bg/memphis-colorful.png');">
                <h4 class="fw-bold">Login Admin atau User</h4>
